...
var KISSY = function (a) {
  ...
  o = {
    ...
    log: function (g, c, m) {
      if (o.Config.debug && (m && (g = m + ": " + g), i.console !== a && console.log)) console[c && console[c] ? c : "log"](g)
    },
    error: function (a) {
      if (o.Config.debug) throw a instanceof Error ? a : Error(a);
    },
    guid: function (a) {
      return (a || "") + h++
    }
...
(function (a, i) {
  ...
  function g(j, d, k, n, e, t) {
    ...
    if (n) {
      p = n.length;
      for (l = 0; l < p; l++) g = n[l], g in d && c(g, j, d, k, n, e, t)
    } else {
      f = a.keys(d);
      p = f.length;
      for (l = 0; l < p; l++) g = f[l], g != m && c(g, j, d, k, n, e, t)
    }
    return j
  }
  ...
  function c(j, d, k, n, e, l, c) {
    if (n || !(j in d) || l) {
      var f = d[j],
        k = k[j];
      if (f === k) f === i && (d[j] = f);
      else if (l && k && (a.isArray(k) || a.isPlainObject(k))) k[m] ? d[j] = k[m] : (l = f &&
        (a.isArray(f) || a.isPlainObject(f)) ? f : a.isArray(k) ? [] : {}, d[j] = l, g(l, k, n, e, b, c));
      else if (k !== i && (n || !(j in d))) d[j] = k
    }
  }
  var m = "__MIX_CIRCULAR",
    f = this,
    b = !0,
    e = Object.create,
    p = !{
    ...
    l = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toString,toLocaleString,valueOf".split(",");
  (function (a, d) {
    for (var k in d) a[k] = d[k]
  })(a, {
    stamp: function (j, d, k) {
      if (!j) return j;
      var k = k || "__~ks_stamped",
        n = j[k];
      if (!n && !d) try {
        n = j[k] = a.guid(k)
      } catch (e) {
    ...
    keys: function (a) {
      ...
      for (k in a) d.push(k);
      if (p)
        for (n = l.length - 1; 0 <= n; n--) k = l[n], a.hasOwnProperty(k) && d.push(k);
      return d
    },
    mix: function (a, d, k, n, e) {
      ...
      var b = [],
        l = 0;
      for (g(a, d, k, n, e, b); d = b[l++];) delete d[m];
      return a
    },
    merge: function (j) {
    ...
    augment: function (j, d) {
      ...
      a.isBoolean(b) || (b = i, n++);
      for (; e <
        n; e++) a.mix(j.prototype, k[e].prototype || k[e], b, l);
      return j
    },
    ...
    namespace: function () {
      ...
      for (n = 0; n < d; n++) {
        c = ("" + e[n]).split(".");
        k = g ? f : this;
        for (l = f[c[0]] === k ? 1 : 0; l < c.length; ++l) k = k[c[l]] = k[c[l]] || {}
      }
      return k
    }
  })
  ...
  a.mix(a, {
    ...
    unique: function (e, b) {
      ...
      for (var j = 0, d, k; j < l.length;) {
        for (k = l[j];
          (d = a.lastIndexOf(k, l)) !== j;) l.splice(d, 1);
        j += 1
      }
      b && l.reverse();
      return l
    ...
    map: b ? function (a, c, l) {
      ...
      for (var j =
          a.length, d = Array(j), k = 0; k < j; k++) {
        var n = "string" == typeof a ? a.charAt(k) : a[k];
        if (n || k in a) d[k] = b.call(l || this, n, k, a)
      }
      return d
    },
    reduce: function (a, b, l) {
      ...
      if (0 === j && 2 == arguments.length) throw new TypeError("arguments invalid");
      var d = 0,
        k;
      if (3 <= arguments.length) k = arguments[2];
        ...
        do {
          ...
          d += 1;
          if (d >= j) throw new TypeError;
        } while (1)
      }
      for (; d < j;) d in a && (k = b.call(i, k, a[d], d, a)), d++;
      return k
    },
    every: m ? function (a,
      b, l) {
      ...
      for (var j = a && a.length || 0, d = 0; d < j; d++)
        if (d in a && !b.call(l, a[d], d, a)) return !1;
      return !0
    },
    some: f ? function (a, b, l) {
      ...
      for (var j = a && a.length || 0, d = 0; d < j; d++)
        if (d in a && b.call(l, a[d], d, a)) return !0;
      return !1
    },
    makeArray: function (b) {
      ...
      for (var c = [], l = 0, j = b.length; l < j; l++) c[l] = b[l];
      return c
    }
  })
})(KISSY);
  ...
  a.mix(a, {
    ...
    param: function (b, j, d, k) {
      ...
      a.isUndefined(k) &&
        (k = !0);
      var n = [],
        e, f, g, m, h, p = a.urlEncode;
      for (e in b)
        if (h = b[e], e = p(e), o(h)) n.push(e), h !== i && n.push(d, p(h + c)), n.push(j);
        else if (a.isArray(h) && h.length) {
        f = 0;
        for (m = h.length; f < m; ++f) g = h[f], o(g) && (n.push(e, k ? p("[]") : c), g !== i && n.push(d, p(g + c)), n.push(j))
      }
      n.pop();
      return n.join(c)
    },
...
(function (a, i) {
  function o(b, e, f) {
    var g = b,
      j, d, k, n;
    if (!b) return g;
    if (b[m]) return f[b[m]].destination;
    if ("object" === typeof b) {
      n = b.constructor;
      if (a.inArray(n, [Boolean, String, Number, Date, RegExp])) g = new n(b.valueOf());
      else if (j = a.isArray(b)) g = e ? a.filter(b, e) : b.concat();
      else if (d = a.isPlainObject(b)) g = {};
      b[m] = n = a.guid();
      f[n] = {
        destination: g,
        input: b
    ...
    if (j)
      for (b = 0; b < g.length; b++) g[b] = o(g[b], e, f);
    else if (d)
      for (k in b)
        if (k !== m && (!e || e.call(b, b[k], k, b) !== c)) g[k] = o(b[k], e, f);
    return g
  }
...
(function (a, i) {
  function o(a, d, k) {
    if (a instanceof m) return k(a[p]);
    var b = a[p];
    if (a = a[l]) a.push([d, k]);
    else if (g(b)) o(b, d, k);
    else return d && d(b);
  ...
  a.mix(c, {
    ...
    all: function (a) {
      var d = a.length;
      if (!d) return a;
      for (var k = h(), b = 0; b < a.length; b++)(function (b, n) {
        f(b, function (b) {
          a[n] = b;
          0 === --d &&
            k.resolve(a)
...
(function (a) {
  function i(a, c) {
    for (var h = 0, f = a.length - 1, b = [], e; 0 <= f; f--) e = a[f], "." != e && (".." === e ? h++ : h ? h-- : b[b.length] = e);
    if (c)
      for (; h--; h) b[b.length] = "..";
    return b = b.reverse()
  }
    ...
    h = {
      resolve: function () {
        var g = "",
          c, h = arguments,
          f, b = 0;
        for (c = h.length - 1; 0 <= c && !b; c--) f = h[c], "string" == typeof f && f && (g = f + "/" + g, b = "/" == f.charAt(0));
      ...
      relative: function (g, c) {
        var g = h.normalize(g),
          c = h.normalize(c),
          m = a.filter(g.split("/"), function (a) {
            return !!a
          }),
          f = [],
          b, e, i = a.filter(c.split("/"), function (a) {
            return !!a
          });
        e = Math.min(m.length, i.length);
        for (b = 0; b < e && m[b] == i[b]; b++);
        for (e = b; b < m.length;) f.push(".."), b++;
...
(function (a, i) {
  ...
  c.prototype = {
    ...
    toString: function (d) {
      var b = [],
        n, c;
      if (n = this.scheme) b.push(g(n, m)), b.push(":");
      if (n = this.hostname) {
        b.push("//");
        if (c = this.userInfo) b.push(g(c, m)), b.push("@");
        b.push(encodeURIComponent(n));
        if (c = this.port) b.push(":"), b.push(c)
      }
      if (c = this.path) n && !a.startsWith(c, "/") &&
        (c = "/" + c), c = l.normalize(c), b.push(g(c, f));
      if (d = this.query.toString.call(this.query, d)) b.push("?"), b.push(d);
      if (d = this.fragment) b.push("#"), b.push(g(d, e));
      return b.join("")
    }
  };
  c.Query = h;
...
(function (a, i) {
  ...
  p && (p.innerHTML = "<\!--[if IE {{version}}]><s></s><![endif]--\>".replace("{{version}}",
    ""), l = p.getElementsByTagName("s"));
  if (0 < l.length) {
    f = "ie";
    j[m = "trident"] = 0.1;
    if ((b = h.match(/Trident\/([\d.]*)/)) && b[1]) j[m] = d(b[1]);
    b = e[0];
    for (e = e[1]; b <= e; b++)
    ...
    if (!j.ie && (k = o(h))) j[f = "ie"] = k
  } else if ((b = h.match(/AppleWebKit\/([\d.]*)/)) && b[1]) {
    j[m = "webkit"] = d(b[1]);
    if ((b = h.match(/Chrome\/([\d.]*)/)) && b[1]) j[f = "chrome"] = d(b[1]);
    else if ((b = h.match(/\/([\d.]*) Safari/)) && b[1]) j[f = "safari"] =
      d(b[1]);
    if (/ Mobile\//.test(h) && h.match(/iPad|iPod|iPhone/)) {
      j.mobile = "apple";
      if ((b = h.match(/OS ([^\s]*)/)) && b[1]) j.ios = d(b[1].replace("_", "."));
      c = "ios";
      if ((b = h.match(/iPad|iPod|iPhone/)) && b[0]) j[b[0].toLowerCase()] = j.ios
    } else if (/ Android/.test(h)) {
      if (/Mobile/.test(h) && (c = j.mobile = "android"), (b = h.match(/Android ([^\s]*);/)) && b[1]) j.android = d(b[1])
    } else if (b = h.match(/NokiaN[^\/]*|Android \d\.\d|webOS\/\d\.\d/)) j.mobile = b[0].toLowerCase();
    if ((b = h.match(/PhantomJS\/([^\s]*)/)) && b[1]) j.phantomjs = d(b[1])
  } else if ((b =
      h.match(/Presto\/([\d.]*)/)) && b[1]) {
    if (j[m = "presto"] = d(b[1]), (b = h.match(/Opera\/([\d.]*)/)) && b[1]) {
      j[f = "opera"] = d(b[1]);
      if ((b = h.match(/Opera\/.* Version\/([\d.]*)/)) && b[1]) j[f] = d(b[1]);
      if ((b = h.match(/Opera Mini[^;]*/)) && b) j.mobile = b[0].toLowerCase();
      else if ((b = h.match(/Opera Mobi[^;]*/)) && b) j.mobile = b[0]
    }
  } else if ((b = h.match(/MSIE\s([^;]*)/)) && b[1]) {
    if (j[m = "trident"] = 0.1, j[f = "ie"] = d(b[1]), (b = h.match(/Trident\/([\d.]*)/)) && b[1]) j[m] = d(b[1])
  } else if (b = h.match(/Gecko/)) {
    j[m = "gecko"] = 0.1;
    if ((b = h.match(/rv:([\d.]*)/)) &&
      b[1]) j[m] = d(b[1]);
    if ((b = h.match(/Firefox\/([\d.]*)/)) && b[1]) j[f = "firefox"] = d(b[1])
  }
  ...
  if ("object" === typeof process) {
    var n, v;
    if ((n = process.versions) && (v = n.node)) c = process.platform, j.nodejs = d(v)
  }
  j.os = c;
  j.core = m;
  j.shell = f;
...
(function (a) {
  var i = a.Env,
    ...
    h = a.UA,
    g = o.document || {},
    c = "ontouchstart" in g && !h.phantomjs,
    m = (g = g.documentMode) || h.ie,
    f = (i.nodejs && "object" === typeof global ? global : o).JSON;
  g && 9 > g && (f = 0);
  a.Features = {
...
(function (a) {
  ...
  KISSY.Loader.Target = {
    ...
    detach: function (h, g) {
      var c, m;
      if (h) {
        if (c = i(this, h)) g && (m = a.indexOf(g, c), -1 != m && c.splice(m, 1)), (!g || !c.length) && delete(this[o] || (this[o] = {}))[h]
      } else delete this[o]
    },
    fire: function (a, g) {
      var c = i(this, a) || [],
        m, f = c.length;
      for (m = 0; m < f; m++) c[m].call(null, g)
    }
  }
})(KISSY);
(function (a) {
  function i(a) {
    ...
    for (var b = [], e = 0, f = a.length; e < f; e++) b[e] = o(a[e]);
    return b
  }
  ...
  function h(d, b, e) {
    ...
    for (c = 0; c < b.length; c++)
      if (f = d[b[c]], !f || f.status !== e) return 0;
    return 1
  }
  var g = a.Loader,
    c = a.Path,
  ...
  a.mix(l, {
    ...
    normalDepModuleName: function (a, b) {
      var e = 0,
        g;
      if (!b) return b;
      if ("string" == typeof b) return f(b, "../") || f(b, "./") ? c.resolve(c.dirname(a), b) : c.normalize(b);
      for (g = b.length; e < g; e++) b[e] = l.normalDepModuleName(a, b[e]);
      return b
    },
    ...
    getModules: function (b, k) {
      var f = [b],
        c, g, j, h, i = b.Env.mods;
      a.each(k, function (k) {
        c = i[k];
        if (!c || "css" != c.getType()) g = l.unalias(b, k), (j = a.reduce(g, function (a, b) {
          h = i[b];
    ...
    attachModsRecursively: function (a, b, e) {
      var e = e || [],
        ...
        g = a.length,
        j = e.length;
      for (f = 0; f < g; f++) c = l.attachModRecursively(a[f], b, e) && c, e.length = j;
      return c
    },
    ...
    normalizeModNames: function (a, b, e) {
      return l.unalias(a, l.normalizeModNamesWithAlias(a,
        b, e))
    },
    ...
    normalizeModNamesWithAlias: function (a, b, e) {
      ...
      if (b) {
        f = 0;
        for (c = b.length; f < c; f++) b[f] && a.push(i(b[f]))
      }
    ...
    registerModule: function (b, e, f, c) {
      var g = b.Env.mods,
        j = g[e];
      if (!j || !j.fn) l.createModuleInfo(b, e), j = g[e], a.mix(j, {
        name: e,
        status: p,
        fn: f
      }), a.mix(j, c)
    ...
    getMappedPath: function (a, b, e) {
      for (var a = e || a.Config.mappedRules || [], f, e = 0; e < a.length; e++)
        if (f = a[e], b.match(f[0])) return b.replace(f[0], f[1]);
      return b
    }
  })
})(KISSY);
  ...
  a.augment(h, {
    ...
    getFullPath: function () {
      ...
      if (!this.fullpath) {
        ...
        b = e.getBaseUri();
        h = this.getPath();
        if (e.isIgnorePackageNameInUri() &&
          (c = e.getName())) h = g.relative(c, h);
        b = b.resolve(h);
    ...
    getNormalizedRequires: function () {
      ...
      if ((a = this.normalizedRequires) && b == e) return a;
  ...
  function i() {
    for (var m in c) {
      var f = c[m],
        b = f.node,
        e, p = 0;
      if (h.webkit) b.sheet && (p = 1);
      else if (b.sheet) try {
        b.sheet.cssRules && (p = 1)
      } catch (l) {
        e = l.name, "NS_ERROR_DOM_SECURITY_ERR" == e && (p = 1)
      }
      p && (f.callback && f.callback.call(b), delete c[m])
    }
...
(function (a) {
  ...
  a.mix(a, {
    getScript: function (m, f, b) {
      ...
      var f = o.docHead(),
        n = i.createElement(p ? "link" : "script");
...
(function (a, i) {
  ...
  var h = a.Loader,
    ...
    m, f, b = a.Config.fns;
  if (!a.Env.nodejs && c && (f = c.href)) m = new a.Uri(f);
  b.map = function (a) {
    var b = this.Config;
...
(function (a) {
  ...
  a.augment(i, i.Target, {
    ...
    add: function (g, c, i) {
      var f = this.runtime;
      if ("string" == typeof g) h.registerModule(f, g, c, i);
      else if (a.isFunction(g))
        if (i = c, c = g, o.ie) {
          var g = a.Env.host.document.getElementsByTagName("script"),
            b, e, p;
...
(function (a, i) {
  ...
  function g(d, c, g) {
    ...
    a.getScript(y, {
      ...
      success: function () {
        if (c.status == p)
          if (s) f.registerModule(l, m, a.noop);
  ...
  a.augment(c, {
    use: function (a, b, d) {
      var c, e = new o(function () {
        ...
        g = this.runtime,
        a = f.getModNamesAsArray(a),
        a = f.normalizeModNamesWithAlias(g,
          a);
      c = f.unalias(g, a);
      h(this, c, e);
...
(function (a, i) {
  ...
  function m(d, c) {
    ...
    for (r in p) o(p[r], function () {
      if (!--s) {
        for (r in p) a.each(p[r].mods, function (b) {
  ...
  function e(b, c, f) {
    ...
    if (h && !j.isAttached(g, c)) {
      ...
      for (h = 0; h < c.length; h++) i = c[h], !j.isLoaded(g, i) && !j.isAttached(g, i) && (l[i] = 1), i = e(b, i, f), a.mix(l, i)
    }
    return l
  }
  var p = a.Loader,
  ...
  a.augment(h, {
    ...
    use: function (a, b, e) {
      var f = this,
        h = f.runtime,
        a = j.getModNamesAsArray(a),
        a = j.normalizeModNamesWithAlias(h, a),
        i = j.unalias(h, a);
    ...
    calculate: function (b) {
      var c = {},
        f, g, h, i = this.runtime,
        l = {};
      for (f = 0; f < b.length; f++) g = b[f], j.isAttached(i, g) || (j.isLoaded(i, g) || (c[g] = 1), a.mix(c,
        e(this, g, l)));
      b = [];
      for (h in c) b.push(h);
      return b
    ...
    getComboUrls: function (b) {
      ...
      for (m in h)
        for (o in h[m]) {
          ...
          var u = h[m][o],
            z = u.packageInfo,
            C = (e = z.getTag()) ? "?t=" + encodeURIComponent(e) : "",
            F =
            C.length,
          ...
          for (e = 0; e < u.length; e++)
            if (x = u[e].getFullPath(), i[o][m].mods.push(u[e]), !z.isCombine() || !a.startsWith(x, B)) i[o][m].push(x);
            else if (x = x.slice(B.length).replace(/\?.*$/, ""), l.push(x), l.length > s || D + l.join(p).length + F > r) l.pop(), E(), l = [], e--;
          l.length && E()
        }
      return i
    }
...
(function (a, i) {
  function o() {
    var c = /^(.*)(seed|kissy)(?:-min)?\.js[^/]*/i,
      b = /(seed|kissy)(?:-min)?\.js/i,
      e, h, l = g.host.document.getElementsByTagName("script"),
      j = l[l.length - 1],
      l = j.src,
      j = (j = j.getAttribute("data-config")) ? (new Function("return " + j))() : {};
    e = j.comboPrefix = j.comboPrefix || "??";
    h = j.comboSep = j.comboSep || ",";
    var d, k = l.indexOf(e); - 1 == k ? d = l.replace(c, "$1") : (d = l.substring(0, k), "/" != d.charAt(d.length - 1) && (d += "/"), l = l.substring(k + e.length).split(h), a.each(l, function (a) {
      return a.match(b) ? (d += a.replace(c,
        "$1"), !1) : i
    }));
    return a.mix({
      base: d
...
(function (a, i) {
  ...
  var h = a.Env.host,
    g = a.UA,
    c = h.document,
    m = c && c.documentElement,
    f = h.location,
    b = new a.Defer,
    e = b.promise,
    p = /^#?([\w-]+)$/,
    l = /\S/,
    j = !(!c || !c.addEventListener),
    d = "load",
    k = j ? function (a, b, c) {
  ...
  a.mix(a, {
    ...
    globalEval: function (a) {
      a && l.test(a) && (h.execScript || function (a) {
        h.eval.call(h, a)
      })(a)
    },
    ready: function (a) {
  ...
  if (f && -1 !==
    (f.search || "").indexOf("ks-debug")) a.Config.debug = !0;
  (function () {
    if (!c || "complete" === c.readyState) o();
    else if (k(h, d, o), j) {
      var a = function () {
